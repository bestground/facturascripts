...
<head>
   ...
   <link rel="stylesheet" href="plugins/plantilla_web/view/css/<?php if( isset($fsc->user->template) ){ ?><?php echo $fsc->user->template;?><?php }else{ ?>bootstrap-yeti.css<?php } ?>" />
...
<body>
            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                     ...
                     <li><a href="<?php echo $fsc->user->get_agente_url();?>">Empleado: <?php echo $fsc->user->codagente;?></a></li>
                     <?php } ?>
   ...
   <div class="container-fluid" style="margin: 10px 0px 10px 0px;">
      <div class="row">
         <div class="<?php if( $fsc->custom_search ){ ?>col-lg-10 col-md-10 col-sm-10 col-xs-12<?php }else{ ?>col-lg-12<?php } ?>">
