...
<ul class="nav nav-tabs" id="ul_tabs">
   <li<?php if( !isset($_GET['public']) AND !isset($_GET['solo_stock']) ){ ?> class="active"<?php } ?>>
      <a href="<?php echo $fsc->url();?>">Todos</a>
   </li>
   <li<?php if( isset($_GET['solo_stock']) ){ ?> class="active"<?php } ?>>
      <a href="<?php echo $fsc->url();?>&solo_stock=TRUE">Stock</a>
   </li>
   <li<?php if( isset($_GET['public']) ){ ?> class="active"<?php } ?>>
      <a href="<?php echo $fsc->url();?>&public=TRUE">Públicos</a>
   </li>
...
<div id="div_articulos">
   <div class="table-responsive">
      <table class="table table-hover">
         ...
         <tr class="clickableRow<?php if( $value1->bloqueado ){ ?> bg-danger<?php }elseif( $value1->stockfis<$value1->stockmin ){ ?> bg-warning<?php } ?>" href="<?php echo $value1->url();?>">
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
            	<div class="form-group">
            		...
            		<strong>Última Referencia añadida: <?php echo $fsc->ultima_referencia;?></strong>
            		</div>
            	</div>
               <div class="form-group">
   ...
   <div class="modal fade" id="modal_modificar_iva">
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-footer">
               <button class="btn btn-sm btn-primary" type="submit" onclick="this.disabled=true;this.form.submit();">
                  <span class="glyphicon glyphicon-floppy-disk"></span> &nbsp; Mover
               </button>
            </div>
         </div>
      </div>
